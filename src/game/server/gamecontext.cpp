...
void CGameContext::CheckPureTuning()
{
	...
	if(	str_comp(m_pController->m_pGameType, "Inf++")==0)
	{
		CTuningParams p;
	}
}
...
void CGameContext::OnClientEnter(int ClientID)
{
	...
	SendBroadcast("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nAt least 3 players required to start playing", ClientID);
	char aBuf[512];
...
void CGameContext::FunEvent(bool rcon)
{
...
void CGameContext::ConFunEvent(IConsole::IResult *pResult, void *pUserData)
{
	CGameContext *pSelf = (CGameContext *)pUserData;
	pSelf->FunEvent(true);
}
